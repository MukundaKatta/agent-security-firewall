"""agent-security-firewall — models module. Security middleware protecting AI agents from prompt injection"""
import logging
...
class Models:
    """Core Models implementation for agent-security-firewall."""
